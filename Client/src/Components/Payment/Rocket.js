...
const Rocket = () => {
  ...
  return (
    <div className='bg-white'>
      <div className='py-10'>
      <div className='w-[350px] md:w-[400px] lg:w-[550px] mx-auto border rounded-lg shadow-lg my-10'>
        <img src='https://pay.payment-2brogamers.com/assets/template/images/rocket.png' alt='hesaf' 
          className='block p-2 border rounded-full shadow-lg mb-10 mt-5 mx-auto h-24 w-24'/>
        <div className='grid grid-cols-12 w-[300px] md:w-[380px] lg:w-[500px] my-5 mx-auto gap-6'>
            <div className='grid col-span-12 lg:col-span-8 rounded-lg border shadow-md'>
               <div className='flex'>
                    <div className=''>
                    <img src='https://pay.payment-2brogamers.com/assets/template/images/rocket.png' alt='fudhv' 
                     className='rounded-full h-14 py-2 px-auto w-14 ml-3 my-5 border'/>
                    </div>
                    <div className='ml-3'>
            ...
            <div className='grid col-span-12 lg:col-span-4 shadow-md rounded-lg border'>
                <h1 className='text-center my-auto py-5 font-bold'>Total {price}.00 Yk</h1>
            </div>
        </div>
        <div className='w-[300px] md:w-[380px] lg:w-[500px] border mx-auto bg-[#89288F] shadow-lg rounded-lg'>
        ...
        <button onClick={handleVerify} className='block mx-auto font-bold text-white rounded-lg py-3 mb-16 mt-6 bg-[#89288F] w-[300px] md:w-[380px] lg:w-[500px]'>VERIFY</button>
    </div>
      </div>
    </div>
  )
