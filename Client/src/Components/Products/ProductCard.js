...
const ProductCard = ({id, heading, image, input, colour, size, price, rating, stock, category, discount}) => {
  ...
  return (
         <div className='w-full '>
                 ...
                 <div className='overflow-hidden'>
                    <img src={image[0]} alt='image4' className='w-full h-48 lg:h-56 rounded-md hover:scale-125 transition-all duration-1000 cursor-pointer'/>
                 </div>
