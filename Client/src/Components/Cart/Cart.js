...
const Cart = () => {
  ...
  return (
    <div className='bg-gray-100'> 
      {
        data.length > 0 ? <div className='hidden md:block'><ViewCart/></div> : <div className='bg-white pb-20'>
            ...
            data.map((cart)=>{
              return <div key={uuidv4()} className='grid grid-cols-12 py-2 border-y rounded mx-4'>
                        <div className='grid col-span-4'>
                          <img src={cart.image} alt='' className='h-24 w-24 mx-auto'/>
                        </div>
                        <div className='grid col-span-8'>
                          <div>
                            ...
                            <div className='grid grid-cols-2'>
                              ...
                              <div><h1 className="float-right text-sm text-right pr-5">{cart.quantity} pcs</h1></div>
                            </div>

                            <div className='grid grid-cols-2'>
                              <div><h1 className="text-black text-sm font-semibold">Total</h1></div>
                              <div><h1 className="float-right font-semibold text-sm text-right pr-5">{cart.quantity*cart.price} Tk</h1></div>
                            </div>
                          </div>
                        </div>
              </div>
