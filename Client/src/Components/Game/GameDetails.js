  ...
  return (
            ...
            <div className='grid grid-cols-12 mx-auto gap-4 w-full md:w-[80%] lg:w-[65%]'>
                ...
                <div className='grid col-span-12 md:col-span-6 mx-auto w-full p-3 rounded-lg'>
                   <h1 className='text-lg lg:text-2xl font-bold text-red-500'>{heading}</h1>
                   <div className="flex">
                     ...
                     <h2 className='text-md lg:text-lg font-semibold py-1 flex'>Price: <span className='text-red-500 px-1'>{price}</span> $</h2>
                    {/* <div className='py-2'>
