...
exports.createProduct = (req, res) => {
    ...
    ProductTemplate.create(productBody)
        .then(template => {
            var attributeIds = []
            ...
            ProductTemplateAttribute.bulkCreate(attributeIds).then(attrs => {
                var attributeValues = []
                ...
                ProductTemplateAttributeValue.bulkCreate(attributeValues).then(values => {
                    var variants = [];
                    ...
                    ProductVariant.bulkCreate(variants).then(variantItems => {
                        ...
                        ProductVariantAttributeValue.bulkCreate(variantAttributeValues).then(_ => {
                            res.send({
                                success: true,
