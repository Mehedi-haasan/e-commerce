...
const SubscCard = ({id, heading, image, input, colour, size, price, rating, stock, category, discount,rules}) => {
  ...
  return (
         <div className='w-full '>
                 ...
                 <h2 className='text-sm mb-1 hover:text-red-500 font-bold'>Price: {price}$</h2>
                 {
                  stock ? <h3 className='mt-1 font-semibold text-sm pb-1 flex'><Icon icon="icon-park-solid:correct" className='mt-1 mr-1 text-red-500'/> In Stock</h3>:<h3 className='mt-1 font-semibold'>Out of Stock</h3>
                 }
