  ...
  return (
    <div className='bg-white'>
       ...
       <div className=' grid col-span-3 ml-5 h-[55vh] hidden lg:block'>
             ...
             <div className='w-[90%] mx-auto'>
              <h1 className='font-semibold text-lg py-2'>Top Rated Products</h1> 
              {
                data.filter((item)=> item.category === "Game").map((cart)=>{
                return <div key={uuidv4()} className='grid grid-cols-12 gap-2 py-2 border-b rounded mr-4'>
                            <div className='grid col-span-3'>
                            <img src={cart.image[0].image} alt='' className='h-18 w-18 rounded'/>
                            </div>
            ...
            <div className=' grid col-span-12 lg:col-span-8'> 
              <div>
              <h1 className='font-semibold pl-3'>Home / Game</h1>
                <div className='grid grid-cols-12 mx-auto  gap-2 mt-3'>
                   {data.map(({id,discount,image,colour,input,size,heading,stock,price,rule,category}) => (
                        ...
                        <GameCard id={id}  discount={discount} image={image} input={input} colour={colour} category={category} rules={rule} size={size} heading={heading} stock={stock} price={price}/>
                        </div>
                    ))}
                </div>
              </div>
