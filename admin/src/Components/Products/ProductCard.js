...
const PracticeCard = ({id, heading, image, input, colour, size, price, rating, stock, category, discount,rules}) => {
  ...
  return (
         <div className='w-full'>
           ...
           <div className="grid col-span-12 md:col-span-6 pb-1">
           ...
           <h2 className='text-sm hover:text-red-500 font-semibold flex'>Price:<span className="text-red-500 text-md lg:text-lg pl-1">{price} $</span></h2>
           </div>
        </div>
                 {
                  stock ? <h3 className='mt-1 font-semibold text-sm flex pb-1'><Icon icon="icon-park-solid:correct" className='mt-1 mr-1 text-red-500'/> In Stock</h3>:<h3 className='mt-1 font-semibold'>Out of Stock</h3>
                 }
